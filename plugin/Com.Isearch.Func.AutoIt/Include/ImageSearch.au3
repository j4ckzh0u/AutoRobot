...
Func _ImageSearch($findImage,$resultPosition,ByRef $x, ByRef $y,$tolerance)
   $w = @DesktopWidth*$scale
   $h = @DesktopHeight*$scale   
   return _ImageSearchArea($findImage,$resultPosition,0,0,$w,$h,$x,$y,$tolerance)
EndFunc
...
Func IsWin10()
   $os_name = GetOSVersion()
   If StringInStr($os_name, 'windows 10')  then
	  return True
   EndIf
   return False
EndFunc
